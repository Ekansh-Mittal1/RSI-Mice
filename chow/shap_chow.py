...
model = load_model(pp+"/chow_model_"+pp+".h5")
...
shap.summary_plot(shap_values[0], plot_type='bar', feature_names=cols, max_display=20)
...
shap_importance.to_csv(pp+'/chow_importances.tsv', sep='\t')
